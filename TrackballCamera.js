...
THREE.TrackballCamera = function ( parameters ) {
	...
	this.rotateSpeed = parameters.rotateSpeed || .5;
	...
	function mousemove( event ) {
		...
		} else if ( _state === this.STATE.ROTATE && event.altKey) {
		...
		} else if ( _state === this.STATE.PAN && !this.noPan && event.altKey) {
...
THREE.TrackballCamera.prototype.STATE = { NONE : -1, ROTATE : 0, ZOOM : 2, PAN : 1 };
